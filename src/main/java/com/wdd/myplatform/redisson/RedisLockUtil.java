...
import com.wdd.myplatform.utils.SpringUtil;
...
public class RedisLockUtil {
    ...
    private static DistributedLocker distributedLocker = SpringUtil.getBean("redisDistributedLocker",DistributedLocker.class);
